...
const APPLE_ID = 0x04C3;
const MANUF_DATA = [195,4,1,131,51,108,102,219,104,239,10,149,70,239,108];
...
class Entry extends Component {
    ...
    start() {
        ...
        this.onDeviceFound = eventEmitter.addListener('onDeviceFound', (event) => {
            console.log('onDeviceFound', event);
            // console.log(event.serviceUuids)
            if (event.serviceUuids) {
                for(let i=0; i< event.serviceUuids.length; i++){
                    console.log(event.serviceUuids[i])
